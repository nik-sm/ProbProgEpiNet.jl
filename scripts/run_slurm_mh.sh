...
for noise in ${noises[@]}; do
    ...
    outfile=$LOG_DIR/time\=$timestamp,inf_strat\=$inf_strat,num_chains\=$num_chains,noise\=$noise,county\=$county,noise_fn\=$noise_fn,E0\=$fixed_total_E0
